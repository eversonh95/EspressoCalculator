...
def regular_cafe():
    ...
    if 50 <= resultado_extracao_arredondada <= 50.9:
        resultado.config(
            text=f'A porcentagem da sua extração arredondada foi de {resultado_extracao_arredondada}%\nSeu café espresso equilibrado\n Caracteristicas de um Café Equilibrado: Sabor Suave, Boa Doçura, Acidez Moderada, Corpo Adequado, Sabores Balanceados, Aroma Agradavel, Crema Rica, Bom equilibrio CORPO E ACIDEZ ')
